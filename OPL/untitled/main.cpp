...
public:
    ...
    bool isOnLine(const double slope, const Point &linePoint) const {
    ...
    void setX(const int newX) { this->x = newX; }
    void setY(const int newY) { this->y = newY; }
    ...
    pair<double, double> toPolar() const {
...
int main() {
    ...
    cout << "is p1 on line with slope 1 through p2 -> " << p1.isOnLine(1, p2) << endl;
